...
export GH_ORG=j-mascarenhas-tc

# Replace `[...]` with the base host accessible through NGINX Ingress
export BASE_HOST=tradersclub.com.br

export REGISTRY_SERVER=https://index.docker.io/v1/

# Replace `[...]` with the registry username
export REGISTRY_USER=josemarbm23

# Replace `[...]` with the registry password
export REGISTRY_PASS=gimenez295

# Replace `[...]` with the registry email
export REGISTRY_EMAIL=josemarbm23@gmail.com

# Replace `[...]` with the GitHub token
export GH_TOKEN=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

# Replace `[...]` with the GitHub email
export GH_EMAIL=josemar.mascarenhas@tradersclub.com.br
